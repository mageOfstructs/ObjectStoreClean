...
public class Main {
  public static void main(String[] args) throws SQLException {
    ...
    System.out.println(plmSingleton.getInternal().selectPreserving(new PlaneBrandComparator(), new PassengerPlane("Boeing")).showHierrachy());

    PersonManager pmSingleton = PersonManager.instance;
    PersonManager.instance.loadFromSQL();
    ...
    System.exit(0);
    ObjectStore<Person> persons = pmSingleton.load();
    if (persons.size() == 0) {
